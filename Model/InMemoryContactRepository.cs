...
namespace AspNetCore.ControllersAsFilters.Sample.Model
{
    public class InMemoryContactRepository : IContactRepository
    {
        private readonly List<Contact> _contacts = new List<Contact>
        {
            ...
            new Contact { ContactId = 4, Name = "Russell Martin", Address = "1 Blue Jays Way", City = "Toronto" },
            new Contact { ContactId = 5, Name = "Justin Smoak", Address = "1 Blue Jays Way", City = "Toronto" }
        };
